 ...
 * @Description:
 */
public class ChineseDayListingFormatting implements IDayListingFormatting {
    private IDateFormatting dateFormatting;

    public ChineseDayListingFormatting(IDateFormatting pDateFormatting) {
    ...
    private String _buildChainRepresentation(DayOfWeek pStart, DayOfWeek pEnd) {
        return dateFormatting.formatDay(pStart) + "到" + dateFormatting.formatDay(pEnd);
    }
